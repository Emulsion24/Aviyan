  ...
  const phases = [
    {
      ...
      action: "उस क्षेत्र के 1000 गो भक्तों एवं संतों के साथ मिलकर उस जिले में जितने तहसील मुख्यालय है, वहाँ जाकर तहसीलदार अथवा SDM को, माननीय राष्ट्रपति महोदया, भारत के प्रधानमंत्री महोदय, राज्य के माननीय राज्यपाल महोदय, राज्य के मुख्यमंत्री महोदय के नाम प्रार्थना पत्र देंगे।",
      details: [
    ...
    },
    {
      ...
      description: "3 माह प्रतीक्षा करेंगे तथा राज्य सरकार और केंद्र सरकार की ओर से आशा अनुकूल उत्तर और परिणाम नहीं मिलने पर  ",
    ...
    },
    {
      ...
      description: "3 माह (अगस्त, सितम्बर, अक्टूबर) पुनः प्रतीक्षा के पश्चात्र राज्य सरकार और केंद्र सरकार की ओर से आशा अनुकूल उत्तर और परिणाम नहीं मिलने पर ",
    ...
    },
    {
      ...
      description: "3 माह प्रतीक्षा करने पर राज्य सरकार और केंद्र सरकार की ओर से आशा अनुकूल उत्तर और परिणाम नहीं मिलने पर, लाल किले की प्राचीर से सकारात्मक उद्बोधन नहीं मिलने पर सभी राज्यों के 5000 तहसील और 780 जिलो के नियुक्त किए संत एवं गो भक्त एक महीने तैयारी करके अधिकाधिक गो प्रेमियों को लेकर ",
      ...
      details: [
        "एक समय में 30 जिले बैठेगे,सात दिन व्यतीत होने के बाद नए ३० जिलो के गो भक्त आएँगे,780 जिलो से ७/७ दिन ये क्रम चलेगा तो साढ़े 5 माह तक 30000 गो भक्तों की संख्या बनी रहेगी",
    ...
    },
    {
      ...
      description: "इस संकीर्तन में देश के प्रत्येक जिले से 7-7 दिन का समय लेकर अलग अलग तिथियों पर अलग अलग जिलो के गो प्रेमी, गौ संत तथा कार्यकर्ता शामिल होंगे, साढ़े पाँच माह प्रतीक्षा करने पर भी केंद्र सरकार से उचित उत्तर और आशा अनुकूल परिणाम ना मिले, तो ",
        ...
        <div className="relative mt-16 p-8 bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-2xl shadow-xl">
          ...
          <div className="relative text-center space-y-4 ">
            ...
            <p className="text-lg text-gray-800 font-medium leading-relaxed max-w-4xl mx-auto">
              <span className="font-bold text-orange-600">गौ सेवा, गौ सुरक्षा और गौ सम्मान </span> हेतु प्रार्थना का क्रम तब तक जारी रहेगा जब तक की गौ माता जी को गौ सेवा, गौ सुरक्षा और गौ सम्मान नहीं मिल जाता
            </p>
