...
const CampaignActionPlan = () => {
  ...
  const phases = [
    ...
    },
    {
      ...
      description: "3 माह प्रतीक्षा करने पर राज्य सरकार और केंद्र सरकार की ओर से आशा अनुकूल उत्तर और परिणाम नहीं मिलने पर, लाल किले की प्राचीर से सकारात्मक उद्बोधन नहीं मिलने पर सभी राज्यों के 5000 तहसील और 750 जिलो के नियुक्त किए संत एवं गो भक्त एक महीने तैयारी करके अधिकाधिक गो प्रेमियों को लेकर ",
        ...
        <div className="relative mt-16 p-8 bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-200 rounded-2xl shadow-xl">
          ...
          <div className="relative text-center space-y-4 ">
            ...
            <p className="text-lg text-gray-800 font-medium leading-relaxed max-w-4xl mx-auto">
              <span className="font-bold text-orange-600">गौ सेवा, गौ सुरक्षा और गौ सम्मान </span> हेतु प्राथना का क्रम तभ तक जारी रहेगा जब तक की गौ माता जी को गौ सेवा, गौ सुरक्षा और गौ सम्मान नहीं मिल जाता
            </p>
