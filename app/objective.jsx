  ...
  const allDemands = [
    {
      ...
      demands: [
        "गोबर, गोमूत्र को लेकर के वृहद अनुसंधान और विश्वविद्यालय बने जिससे गोबर, गोमूत्र का कृषि और अन्य उपयोग में महत्व बढ़े।",
      ...
      <div className="relative max-w-6xl mx-auto px-4 space-y-16">
        ...
        <div className="relative text-center">
          <div className="flex items-center justify-center gap-6 md:gap-8">
            {/* Left ornament */}
            <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center animate-bounce drop-shadow-[0_4px_8px_rgba(255,166,0,0.4)]">
          <Image
              src="/3.png"
              alt="left decoration"
              width={64}
            ...
            {/* Right ornament */}
            <div className="w-12 md:w-16 h-12 md:h-16 bg-gradient-to-br from-yellow-500 to-amber-400 rounded-full flex items-center justify-center animate-bounce drop-shadow-[0_4px_8px_rgba(255,166,0,0.4)]" style={{ animationDelay: '1s' }}>
            <Image
              src="/2.png"
