...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-yellow-50">
      <div
        className="relative text-center mb-10 rounded-3xl p-6 sm:p-10 
             ...
             overflow-hidden mx-4 md:mx-auto max-w-7xl"
      >
        ...
        {/* Description */}
        <p className="relative text-base sm:text-lg md:text-xl text-orange-900/90 font-medium max-w-3xl mx-auto leading-relaxed mb-8">
          ...
          <span className="inline-block mt-1 sm:mt-0 font-semibold text-white bg-orange-600/70 px-2 py-1 rounded-lg shadow-sm">
        ...
        <div className="relative flex flex-wrap justify-center gap-4 sm:gap-6">
          ...
          <a
            href="tel:9571712140"
            className="flex w-full sm:w-auto items-center justify-center gap-3 px-5 sm:px-7 py-3.5 
                       bg-white/80 backdrop-blur-sm rounded-2xl 
                       border border-blue-200 hover:border-blue-400
                       hover:bg-blue-50 transition-all duration-300 
                       shadow-lg hover:shadow-blue-300/40"
          >
            <Phone className="text-blue-600 text-2xl sm:text-3xl shrink-0" />
          ...
          >
            <Phone className="text-red-600 text-2xl sm:text-3xl shrink-0" />
          ...
          >
            <FaWhatsapp className="text-green-600 text-2xl sm:text-3xl shrink-0" />
          ...
          >
            <FaEnvelope className="text-orange-600 text-2xl sm:text-3xl shrink-0" />
            <span className="font-bold text-base sm:text-lg text-orange-800 break-all">
      ...
      <div className="max-w-4xl mx-auto mt-8 text-gray-700 text-center font-extrabold leading-relaxed px-4">
        <div
          className="bg-orange-400 border-4 border-yellow-300 text-white rounded-2xl p-6 shadow-2xl shadow-orange-900/50 my-8
        ...
        <div
          className="bg-red-800 border-4 border-yellow-300 rounded-2xl p-6 shadow-2xl shadow-red-900/50 my-8 
                    relative overflow-hidden
                    before:content-[''] before:absolute before:inset-0 before:bg-yellow-300 before:opacity-20 before:animate-pulse-strong 
                    before:rounded-2xl"
        >
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-3 mb-4">
            <span className="text-5xl animate-bounce-slow hidden md:inline-block">🚨</span>
            <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-yellow-50 uppercase tracking-wide text-center">
              <span className="md:hidden">🚨 </span>NO Donation | कोई दान नहीं<span className="md:hidden"> 🚨</span>
            </h3>
            <span className="text-5xl animate-bounce-slow hidden md:inline-block">🚨</span>
          </div>

          <p className="relative z-10 text-yellow-100 font-bold text-lg sm:text-xl md:text-2xl text-center leading-relaxed mb-4">
            इस अभियान हेतु किसी भी प्रकार का दान या चंदा स्वीकार नहीं किया जा रहा है।
          </p>

          <div className="relative z-10 text-white font-semibold text-base sm:text-lg md:text-xl text-center mt-4">
            अगर कोई इस अभियान के नाम से दान या चंदा मांगे, तो तुरंत
            <a
              href="tel:8239711008"
              className="inline-flex items-center justify-center gap-2 mx-2 my-2 md:my-0 px-4 sm:px-5 py-2 bg-green-500 text-white rounded-lg 
                     hover:bg-green-600 transition-all font-bold shadow-lg hover:shadow-xl text-lg sm:text-xl 
                     ring-2 ring-green-400 animate-pulse-fast"
            >
              📞 8239711008
            </a>
            <span className="block md:inline">नंबर पर शिकायत करें।</span>
          </div>

          <div className="relative z-10 mt-6 text-center">
            <p className="text-yellow-300 font-bold text-base sm:text-lg md:text-xl italic">
